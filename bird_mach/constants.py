...
SUPPORTED_AUDIO_EXTENSIONS = frozenset({".wav", ".mp3", ".flac", ".ogg", ".m4a", ".aac"})
SUPPORTED_FORMATS = frozenset(SUPPORTED_AUDIO_EXTENSIONS)
...
SUPPORTED_EXPORT_FORMATS = frozenset({"json", "csv", "tsv", "html", "md"})
